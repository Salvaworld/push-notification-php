...
class PushNotificationTest extends TestCase {
    ...
    /** @test */
    public function push_notification_instance_creation_without_argument_set_fcm_as_service() {
        $push = new PushNotification();

        $this->assertInstanceOf('SalvaWorld\PushNotification\Fcm', $push->service);
    }
    ...
    /** @test */
    public function if_push_service_as_argument_is_not_valid_user_fcm_as_default() {
    ...
    public function if_argument_in_set_service_method_does_not_exist_set_the_service_by_default() {
        ...
        $this->assertInstanceOf('SalvaWorld\PushNotificationFcm', $push->service);
