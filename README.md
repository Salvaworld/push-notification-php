...
[![Build Status](https://api.travis-ci.org/SalvaWorld/PushNotification.svg)](https://api.travis-ci.org/SalvaWorld/PushNotification)
[![Total Downloads](https://poser.pugx.org/salvaworld/push-notification-php/downloads)](https://packagist.org/packages/salvaworld/push-notification-php)
[![Latest Stable Version](https://poser.pugx.org/salvaworld/push-notification-php/v/stable)](https://packagist.org/packages/salvaworld/push-notification-php)
[![License](https://poser.pugx.org/salvaworld/push-notification-php/license)](https://packagist.org/packages/salvaworld/push-notification-php)
...
```
composer require "salvaworld/push-notification-php:^v3.0.0"
```
...
```
composer require salvaworld/push-notification-php
```
...
```
php artisan vendor:publish --provider="SalvaWorld\PushNotification\Providers\PushNotificationServiceProvider" --tag="config"
```

> Go to [laravel facade sample](https://github.com/salvaworld/PushNotification#laravel-alias-facade) directly.
...
- [setService](https://github.com/salvaworld/PushNotification#setservice)
- [setMessage](https://github.com/salvaworld/PushNotification#setmessage)
- [setDevicesToken](https://github.com/salvaworld/PushNotification#setdevicestoken)
- [send](https://github.com/salvaworld/PushNotification#send)
- [getFeedback](https://github.com/salvaworld/PushNotification#getfeedback)
- [getUnregisteredDeviceTokens](https://github.com/salvaworld/PushNotification#getunregistereddevicetokens)
- [setConfig](https://github.com/salvaworld/PushNotification#setconfig)
- [setUrl](https://github.com/salvaworld/PushNotification#seturl)

### Only for Gcm and Fcm

- [setApiKey](https://github.com/salvaworld/PushNotification#setapikey)

### Only for Fcm

- [sendByTopic](https://github.com/salvaworld/PushNotification#sendbytopic)

> Go to [Usage samples](https://github.com/salvaworld/PushNotification#usage-samples) directly.
...
If a notification supports being sent as an push message, you should define  `toApn` and/or `toFcm`/`toGcm` methods on the notification class. This method will receive a `$notifiable` entity and should return a  `SalwaWorld\PushNotification\Messages\PushMessage` instance:
